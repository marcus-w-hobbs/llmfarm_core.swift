...
public class FineTune {
  ...
  public var tuneQueue = DispatchQueue(
    label: "LLMFarm-Tune", qos: .userInitiated, attributes: .concurrent,
  ...
  public init(
    _ model_base: String, _ lora_out: String, _ train_data: String,
  ...
  public func finetune(_ progressCallback: ((String) -> Void)?) throws {
